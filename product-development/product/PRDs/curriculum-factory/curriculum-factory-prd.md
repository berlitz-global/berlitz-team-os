...
Not all channels required for the launch of the mobile app. 

*Self-paced learning content (async, in-app):*

| Output format                               | Key fields                                                                                                        | Notes                                                              |
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| **Practice <br>(self-paced lesson screen)** | Vocabulary introduction, grammar explanation, reading passage, interactive drills (tap-based), media placeholders | The 9 lessons per module in the learner path (content-taxonomy.md) |
| **Practice (Review unit)**                  | Exercises revisiting vocabulary, grammar, and dialog from preceding lessons in the module                         | 9 review units per module (Flex-only)                              |
...
| FR-22 | !!! Curriculum Factory pushes content to target system (LMS)? Or talks directly to mobile app? Or is CF = LMS?<br>!!!                                                                                                                                                                                                                                                            | P0       | !!!                        | !!!                                       |
